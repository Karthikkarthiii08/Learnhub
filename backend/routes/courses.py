...
def get_courses():
    # Auto-seed if empty (handles Vercel cold starts)
...
# ── AUTO SEED (called when DB is empty) ──

_LESSON_VIDS = ["kqtD5dpn9C8", "DZwmZ8Usvnk", "9Os0o3wzS_I", "JeznW_7DlB0"]
_LESSON_TITLES = ["Introduction & Overview", "Core Concepts", "Hands-on Practice", "Advanced Topics", "Project & Review"]
_SEED_COURSES = [
  dict(title="Complete Python by Shradha Khapra", instructor="Shradha Khapra", thumbnail="https://img.youtube.com/vi/_uQrJ0TkZlc/maxresdefault.jpg", duration_weeks=12, rating=4.8, is_premium=False, category="Python", level="Beginner", description="Complete Python from scratch covering variables, loops, functions and OOP.", main_vid="_uQrJ0TkZlc"),
  dict(title="Python Full Course - freeCodeCamp", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/eWRfhZUzrAc/maxresdefault.jpg", duration_weeks=14, rating=4.9, is_premium=False, category="Python", level="Beginner", description="Comprehensive Python course from freeCodeCamp.", main_vid="eWRfhZUzrAc"),
  dict(title="Python OOP by Corey Schafer", instructor="Corey Schafer", thumbnail="https://img.youtube.com/vi/ZDa-Z5JzLYM/maxresdefault.jpg", duration_weeks=6, rating=4.9, is_premium=False, category="Python", level="Intermediate", description="Master object-oriented programming in Python.", main_vid="ZDa-Z5JzLYM"),
  ...
  dict(title="Web Development by Apna College", instructor="Apna College", thumbnail="https://img.youtube.com/vi/tVzUXW6siu0/maxresdefault.jpg", duration_weeks=12, rating=4.8, is_premium=False, category="Web Development", level="Beginner", description="Full web development course covering HTML, CSS, JavaScript.", main_vid="tVzUXW6siu0"),
  dict(title="HTML & CSS Full Course", instructor="SuperSimpleDev", thumbnail="https://img.youtube.com/vi/G3e-cpL7ofc/maxresdefault.jpg", duration_weeks=6, rating=4.8, is_premium=False, category="Web Development", level="Beginner", description="Learn HTML and CSS from scratch.", main_vid="G3e-cpL7ofc"),
  dict(title="CSS Flexbox & Grid by Kevin Powell", instructor="Kevin Powell", thumbnail="https://img.youtube.com/vi/phWxA89Dy94/maxresdefault.jpg", duration_weeks=4, rating=4.9, is_premium=False, category="Web Development", level="Intermediate", description="Master CSS Flexbox and Grid layout systems.", main_vid="phWxA89Dy94"),
  ...
  dict(title="React JS Full Course by Dave Gray", instructor="Dave Gray", thumbnail="https://img.youtube.com/vi/RVFAyFWO4go/maxresdefault.jpg", duration_weeks=8, rating=4.9, is_premium=True, category="JavaScript", level="Intermediate", description="Complete React JS course covering hooks, context, and modern patterns.", main_vid="RVFAyFWO4go"),
  dict(title="Next.js Full Course by Traversy", instructor="Traversy Media", thumbnail="https://img.youtube.com/vi/mTz0GXj8NN0/maxresdefault.jpg", duration_weeks=8, rating=4.9, is_premium=True, category="JavaScript", level="Intermediate", description="Next.js full course covering SSR, SSG, API routes.", main_vid="mTz0GXj8NN0"),
  dict(title="TypeScript Full Course", instructor="Academind", thumbnail="https://img.youtube.com/vi/BwuLxPH8IDs/maxresdefault.jpg", duration_weeks=6, rating=4.8, is_premium=False, category="JavaScript", level="Intermediate", description="TypeScript from scratch - types, interfaces, generics.", main_vid="BwuLxPH8IDs"),
  ...
  dict(title="Vue.js 3 Full Course", instructor="Net Ninja", thumbnail="https://img.youtube.com/vi/YrxBCBibVo0/maxresdefault.jpg", duration_weeks=8, rating=4.7, is_premium=False, category="JavaScript", level="Intermediate", description="Vue.js 3 complete course with Composition API.", main_vid="YrxBCBibVo0"),
  dict(title="Machine Learning by Sentdex", instructor="Sentdex", thumbnail="https://img.youtube.com/vi/OGxgnH8y2NM/maxresdefault.jpg", duration_weeks=16, rating=4.8, is_premium=True, category="Data Science", level="Intermediate", description="Practical machine learning with Python and scikit-learn.", main_vid="OGxgnH8y2NM"),
  dict(title="Deep Learning with TensorFlow", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/tPYj3fFJGjk/maxresdefault.jpg", duration_weeks=14, rating=4.8, is_premium=True, category="Data Science", level="Advanced", description="Deep learning with TensorFlow and Keras from scratch.", main_vid="tPYj3fFJGjk"),
  ...
  dict(title="Power BI Full Course", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/NNSHu0rkew8/maxresdefault.jpg", duration_weeks=8, rating=4.7, is_premium=False, category="Data Science", level="Beginner", description="Power BI complete course for data visualization.", main_vid="NNSHu0rkew8"),
  dict(title="Statistics for Data Science", instructor="StatQuest", thumbnail="https://img.youtube.com/vi/qBigTkBLU6g/maxresdefault.jpg", duration_weeks=10, rating=4.9, is_premium=False, category="Data Science", level="Beginner", description="Statistics fundamentals for data science.", main_vid="qBigTkBLU6g"),
  ...
  dict(title="MongoDB Full Course", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/ExcRbA7fy_A/maxresdefault.jpg", duration_weeks=6, rating=4.6, is_premium=False, category="Database", level="Beginner", description="MongoDB NoSQL database complete course.", main_vid="ExcRbA7fy_A"),
  dict(title="PostgreSQL Full Course", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/qw--VYLpxG4/maxresdefault.jpg", duration_weeks=8, rating=4.7, is_premium=False, category="Database", level="Intermediate", description="PostgreSQL complete course covering advanced SQL.", main_vid="qw--VYLpxG4"),
  dict(title="GraphQL Full Course", instructor="Traversy Media", thumbnail="https://img.youtube.com/vi/ed8SzALpx1Q/maxresdefault.jpg", duration_weeks=6, rating=4.7, is_premium=True, category="Database", level="Intermediate", description="GraphQL complete course for building flexible APIs.", main_vid="ed8SzALpx1Q"),
  ...
  dict(title="Android Development Java", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/fis26HvvDII/maxresdefault.jpg", duration_weeks=14, rating=4.6, is_premium=False, category="Java", level="Intermediate", description="Android app development with Java from scratch.", main_vid="fis26HvvDII"),
  ...
  dict(title="Android Kotlin Full Course", instructor="freeCodeCamp", thumbnail="https://img.youtube.com/vi/EExSSotojVI/maxresdefault.jpg", duration_weeks=12, rating=4.7, is_premium=False, category="Mobile", level="Beginner", description="Android development with Kotlin from scratch.", main_vid="EExSSotojVI"),
  dict(title="C++ Full Course by Bro Code", instructor="Bro Code", thumbnail="https://img.youtube.com/vi/-TkoO8Z07hI/maxresdefault.jpg", duration_weeks=10, rating=4.6, is_premium=False, category="Other", level="Beginner", description="C++ complete course from basics to OOP.", main_vid="-TkoO8Z07hI"),
  dict(title="Rust Programming Language", instructor="Let's Get Rusty", thumbnail="https://img.youtube.com/vi/ygL_xcavzQ4/maxresdefault.jpg", duration_weeks=10, rating=4.7, is_premium=True, category="Other", level="Advanced", description="Rust programming language covering ownership and safety.", main_vid="ygL_xcavzQ4"),
]
...
def _do_seed():
    try:
        if Course.query.count() > 0:
            return
        for data in _SEED_COURSES:
            main_vid = data.copy().pop("main_vid")
            course_data = {k: v for k, v in data.items() if k != "main_vid"}
            course = Course(**course_data)
            db.session.add(course)
            db.session.flush()
            vids = [main_vid] + _LESSON_VIDS
            for i in range(5):
                db.session.add(Lesson(
                    course_id=course.id,
                    title=_LESSON_TITLES[i],
                    video_url=f"https://www.youtube.com/watch?v={vids[i]}",
                    lesson_order=i + 1
                ))
        db.session.commit()
